class ParksController < ApplicationController
  ...
  def show
    ...
    def create
        ...
        @park = Park.new(params.require(:park).permit(:name, :address, :city, :state, :leash, :size, :approved, :trails, :waterbodies, :gated))
    ...
    def update
        ...
        if @park.update(params.require(:park).permit(:name, :address, :leash, :city, :state, :size, :approved, :trails, :waterbodies, :gated))
